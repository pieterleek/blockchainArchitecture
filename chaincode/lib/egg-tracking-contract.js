...
class EggTrackingContract extends Contract {
    ...
    async packEggs(ctx, farmerId, packingTimestamp, quantity) {
        ...
        // TODO: validate current identity and participant
    ...
    async createShipment(ctx, farmerId, shipperId, distributorId, shipmentCreation, min, max) {
        ...
        // TODO for week-4: validate farmer, shipper, distributor
        // TODO for week-4: check if shipment alterady exists
        // TODO for week-4: check min and max
     ...
     */
    isAdmin(identity) {
      console.log('isAdmin ' + identity.getID());
    ...
    async queryPackedEggs(ctx,farmerId, max) {
        ...
        let queryString = {
            selector: {
              type: 'EggBox',
              holderId: farmerId,
              currentState: 'PACKED' // TODO: get constant
            }
        };
